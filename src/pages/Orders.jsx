...
//               {order.deliveryInfo && (order.deliveryInfo.telefono || order.deliveryInfo.phone) && (
//                 <div className="detail-item">
//                   <FontAwesomeIcon icon={faPhone} />
//                   <span><strong>Tel:</strong> {order.deliveryInfo.telefono || order.deliveryInfo.phone}</span>
//                 </div>
//               )}
